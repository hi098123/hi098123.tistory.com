(function(){
	...
	if(ptol[location.pathname]){
		...
		el.innerHTML='<blockquote style="background:#fafafa" data-ke-style="style3"><a href="https://t.hi098123.com/'+ptol[location.pathname]+'" target="_blank" rel="noopener">업데이트 된 툴을 사용하려면?</a> 이 페이지에서는 더 이상 업데이트를 하지 않을 예정입니다.</blockquote>';
