(function(){
	...
	if(ptol[location.pathname]){
		...
		el.innerHTML='<blockquote style="padding:12px 25px;background:#fafafa" data-ke-style="style3">업데이트 된 툴을 사용하려면? <a href="https://t.hi098123.com/'+ptol[location.pathname]+'" target="_blank" rel="noopener">더 향상된 툴 이용하기</a></blockquote>';
